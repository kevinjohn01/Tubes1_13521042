...
public class InputFrameController{
    ...
    private void initialize(){
        ...
        ObservableList<String> playerTypes = FXCollections.observableArrayList("hooman","bot minimax","bot sideways","bot genetic");

        this.numberOfRounds.setItems(numberOfRoundsDropdown);
        this.player1Type.setItems(playerTypes);
        this.player2Type.setItems(playerTypes);
